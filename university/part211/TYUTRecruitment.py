...
def get_data(page, redis, table_name, s):
    ...
    url = 'http://jiuye.tyut.edu.cn/zpweb/RecruitmentSpecial.aspx?Day=all&page=%d' % page
    response = s.get(url)
    content = response.content
    parse_page(content, redis, table_name)


def get_tyut_recruitment():
    # 太原理工大学
    table_name = 'tyut_company_info'
